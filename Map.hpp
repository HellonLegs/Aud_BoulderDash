...
class Map{
    ...
    Map(int lvl, SVG *view){
        ...
        buffer[1] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[2] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[3] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[4] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[5] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[6] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[7] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[8] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[9] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[10] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[11] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[12] = Image("img/titan.png", -16, -16, 16, 16, view);
        buffer[13] = Image("img/titan.png", -16, -16, 16, 16, view);
